...
\par Por meio da interface web desenvolvida, mostrada na figura~\ref{fig:website}, é possível visualizar cada imagem recebida pela Raspberry e fazer o treinamento do banco de dados relacionando a imagem visualizada ao seu número correspondente.
