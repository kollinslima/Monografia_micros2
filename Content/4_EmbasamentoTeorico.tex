...
\par Existem diversos algoritmos que fazem a detecção de borda, tais como operador Roberts, Sobel, Prewitt, etc. Segundo~\cite{Grassi}, as etapas básicas para fazer a detecção de borda são:
\begin{enumerate}
...
\par Para k=3 (considerando 3 vizinhos mais próximos), deve-se considerar apenas as 3 menores distâncias (d4,d2 e d3). Atribui-se uma pontuação à cada um dos vizinhos, que deve ser maior quanto menor for a distância, conforme mostra a tabela~\ref{tab:ranking_knn}.
